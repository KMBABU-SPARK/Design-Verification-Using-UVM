// ex11: Factory type override - new() vs create(), set_type_override_by_type
...
class comp extends uvm_component;
  ...
  function new(string path = "second", uvm_component parent = null);
    ...
    f = first::type_id::create("f");   // factory decides actual type created here
    f.randomize();
    f.print();
  endfunction
endclass
...
module tb;
  comp c;
  initial begin
    // Tell the factory: whenever 'first' is requested, substitute 'first_mod'
