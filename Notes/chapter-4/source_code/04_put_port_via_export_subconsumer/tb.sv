// Example 4: Producer -> Consumer's EXPORT -> subconsumer's IMP.
// Mirrors Example 3, but on the receiving side: consumer does not implement
// put() itself, it forwards through an export down to a child subconsumer.
...
class consumer extends uvm_component;
  ...
  virtual function void connect_phase(uvm_phase phase);
    ...
    expo.connect(s.imp);   // export forwards down to child's imp
  endfunction
endclass
...
/*
DATA FLOW: producer.port --> consumer.expo --> subconsumer.imp --> subconsumer.put()
*/
