// Example 7: uvm_analysis_port / uvm_analysis_imp
// One producer BROADCASTS to many subscribers (1-to-N), non-blocking,
// "fire and forget" - the classic monitor -> scoreboard/coverage pattern.
...
class producer extends uvm_component;
  ...
  task main_phase(uvm_phase phase);
    ...
    port.write(data);   // broadcast to ALL connected imps, no blocking wait
...
class consumer1 extends uvm_component;
  ...
  virtual function void write(int datar);   // write() must be a function - non-blocking
...
class env extends uvm_env;
  ...
  virtual function void connect_phase(uvm_phase phase);
    ...
    p.port.connect(c1.imp);   // ONE port can connect to MANY imps
...
/*
OUTPUT:
UVM_INFO ... [PROD] Data Broadcasted : 12
UVM_INFO ... [CONS1] Data Recv : 12
UVM_INFO ... [CONS2] Data Recv : 12
*/
